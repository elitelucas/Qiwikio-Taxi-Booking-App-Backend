import { Reviews, User, UserProfile, Booking, BookingTips, CurrencyRates, FavoriteDriver } from '../../models';
...
const WriteReviews = {
    ...
    args: {
        ...
        favorite: { type: BooleanType },
        improvement: { type: BooleanType },
        nice: { type: BooleanType },
    },

    async resolve({ request }, { userId, bookingId, authorId, ratings, reviewContent, currency, amount, paymentType, favorite, improvement, nice }) {
        try {
            ...
            if (request.user) {
                ...
                if (amount && amount > 0) {
                    ...
                    if (status === 200) {
                        ...
                        if (favorite) {
                            await FavoriteDriver.findOrCreate({
                                where: {
                                    userId: authorId,
                                    driverId: userId
                                },
